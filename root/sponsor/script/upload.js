...
document.addEventListener("DOMContentLoaded", async function () {
  ...
  validateField(
    document.getElementById("admissionsPeriod"),
    "Admissions Period cannot be empty."
  );
  validateField(
  ...
  validateField(
    ...
    "Session details cannot be empty."
  );
  validateField(
    document.getElementById("totalCSPHours"),
    "Total CSP hours must be a number greater than or equal to 1."
  );
  ...
  eventForm.addEventListener("submit", async function (event) {
    ...
    const formData = {
      ...
      "Project Requirements": document.getElementById("projectRequirements")
        .value,
      ...
      } - ${document.getElementById("volunteerPeriodEnd").value}`, // Format as needed
    };
    ...
    try {
      ...
      document.getElementById(
        "formMessage"
      ).textContent = `${formData["Project Name"]} event successfully created!`;
