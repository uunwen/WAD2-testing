...
// // Utility function to create icon links
// function createIconLink(href, iconClass, target = '_self') {
//   const link = document.createElement('a');
//   link.href = href;
//   link.target = target;
//   link.innerHTML = `<i class="${iconClass} icon-large"></i>`;
//   return link;
// }
...
//     const emailIcon = createIconLink(`mailto:${sponsorData['email_add']}`, 'fas fa-envelope');
...
//     const facebookIcon = createIconLink(sponsorData['facebook_link'], 'fab fa-facebook', '_blank');
//     iconsRow.appendChild(facebookIcon);
//   }
//   if (sponsorData['website']) {
//     const websiteIcon = createIconLink(sponsorData['website'], 'fas fa-globe', '_blank');
