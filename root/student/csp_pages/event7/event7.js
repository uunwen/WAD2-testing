...
function displayEventData(eventData) {
    ...
    const dataDisplayDiv = document.getElementById("event7Data"); // Div to display event7 data
    ...
    displayOrder.forEach(key => {
        ...
        if (key === 'Organiser' && eventData[key]) {
            ...
            organiserLink.href = '../../../student/sponsor_pages/sponsor7/sponsor7.html'; // Correct relative path
...
function fetchEvent7Data() {
    const event7Ref = ref(database, 'events/event7'); // Reference to 'event7' data in Firebase
    ...
    get(event7Ref)
        ...
        .catch((error) => {
            ...
            document.getElementById("event7Data").innerHTML = `<p>Error fetching data: ${error.message}</p>`;
        });
}

// Fetch and display data when the page loads
window.onload = fetchEvent7Data;
